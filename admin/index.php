            ...
            <div class="container-fluid">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        <?php
                            $elements_text = ['Active Post', 'Unpublished Post', 'Categories', 'Users', 'User Subscriber','Comments','Unapprove Comment'];
                            $elements_count = [$post_count, $post_draft_count, $category_count, $user_count, $user_subscriber_count, 
                            $comment_count,$comment_unapproved_count];
